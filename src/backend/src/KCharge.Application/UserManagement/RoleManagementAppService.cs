...
[Authorize(KChargePermissions.RoleManagement.Default)]
public class RoleManagementAppService : KChargeAppService, IRoleManagementAppService
{
    ...
    [Authorize(KChargePermissions.RoleManagement.Create)]
    public async Task<RoleDetailDto> CreateAsync(CreateRoleDto input)
    {
        ...
        {
            throw new BusinessException("KCharge:RoleNameAlreadyExists")
    ...
    [Authorize(KChargePermissions.RoleManagement.Update)]
    public async Task<RoleDetailDto> UpdateAsync(Guid id, UpdateRoleDto input)
    {
        ...
        if (role.IsStatic)
        {
            throw new BusinessException("KCharge:CannotUpdateStaticRole");
        }
    ...
    [Authorize(KChargePermissions.RoleManagement.Delete)]
    public async Task DeleteAsync(Guid id)
    {
        ...
        if (role.IsStatic)
        {
            throw new BusinessException("KCharge:CannotDeleteStaticRole");
        }
        ...
        if (userCount > 0)
        {
            throw new BusinessException("KCharge:CannotDeleteRoleWithUsers")
    ...
    [Authorize(KChargePermissions.RoleManagement.ManagePermissions)]
