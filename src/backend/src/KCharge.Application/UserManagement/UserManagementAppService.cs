...
[Authorize(KChargePermissions.UserManagement.Default)]
public class UserManagementAppService : KChargeAppService, IUserManagementAppService
{
    ...
    [Authorize(KChargePermissions.UserManagement.Create)]
    public async Task<UserDto> CreateAsync(CreateUserDto input)
    {
        ...
        {
            throw new BusinessException("KCharge:UserNameAlreadyExists")
        ...
        {
            throw new BusinessException("KCharge:EmailAlreadyExists")
        ...
        if (!result.Succeeded)
        {
            throw new BusinessException("KCharge:UserCreationFailed")
    ...
    [Authorize(KChargePermissions.UserManagement.Update)]
    ...
    [Authorize(KChargePermissions.UserManagement.Delete)]
    public async Task DeleteAsync(Guid id)
    {
        ...
        {
            throw new BusinessException("KCharge:CannotDeleteCurrentUser");
        }
    ...
    [Authorize(KChargePermissions.UserManagement.ManageRoles)]
    ...
    public async Task LockUserAsync(Guid userId, LockUserDto input)
    {
        ...
        {
            throw new BusinessException("KCharge:CannotLockCurrentUser");
        }
    ...
    public async Task ResetPasswordAsync(Guid userId, ResetPasswordDto input)
    {
        ...
        if (!result.Succeeded)
        {
            throw new BusinessException("KCharge:PasswordResetFailed")
                .WithData("Errors", string.Join(", ", result.Errors.Select(e => e.Description)));
        }
    }
}
