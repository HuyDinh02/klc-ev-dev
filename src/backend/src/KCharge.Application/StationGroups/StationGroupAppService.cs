...
namespace KCharge.StationGroups;

[Authorize(KChargePermissions.StationGroups.Default)]
public class StationGroupAppService : KChargeAppService, IStationGroupAppService
{
    ...
    [Authorize(KChargePermissions.StationGroups.Create)]
    ...
    [Authorize(KChargePermissions.StationGroups.Update)]
    ...
    [Authorize(KChargePermissions.StationGroups.Delete)]
    ...
    [Authorize(KChargePermissions.StationGroups.Assign)]
