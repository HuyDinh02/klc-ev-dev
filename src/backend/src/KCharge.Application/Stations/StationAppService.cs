...
[Authorize(KChargePermissions.Stations.Default)]
public class StationAppService : KChargeAppService, IStationAppService
{
    ...
    [Authorize(KChargePermissions.Stations.Create)]
    ...
    [Authorize(KChargePermissions.Stations.Update)]
    ...
    [Authorize(KChargePermissions.Stations.Decommission)]
