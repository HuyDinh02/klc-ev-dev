...
[Authorize(KChargePermissions.Monitoring.Default)]
public class MonitoringAppService : KChargeAppService, IMonitoringAppService
{
    ...
    [Authorize(KChargePermissions.Monitoring.Dashboard)]
    ...
    [Authorize(KChargePermissions.Monitoring.StatusHistory)]
    ...
    [Authorize(KChargePermissions.Monitoring.EnergySummary)]
