        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletBalance = table.Column<decimal>(type: "numeric(18,0)", precision: 18, scale: 0, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalEnergyKwh = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: false),
                    TotalCost = table.Column<decimal>(type: "numeric(18,0)", precision: 18, scale: 0, nullable: false),
                    TariffPlanId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    IdTag = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppChargingSessions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorInfo = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    VendorErrorCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFaults", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PushSentAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStationGroups", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppStatusChangeLogs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StationId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStatusChangeLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    BaseRatePerKwh = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTariffPlans", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatteryCapacityKwh = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectorNumber = table.Column<int>(type: "integer", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EnergyKwh = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: false),
                    CurrentAmps = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    VoltageVolts = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    PowerKw = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: true),
                    SocPercent = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMeterValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMeterValues_AppChargingSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "AppChargingSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxAmount = table.Column<decimal>(type: "numeric(18,0)", precision: 18, scale: 0, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppInvoices_AppPaymentTransactions_PaymentTransactionId",
                        column: x => x.PaymentTransactionId,
                        principalTable: "AppPaymentTransactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "AppChargingStations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppChargingStations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppChargingStations_AppStationGroups_StationGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalInvoiceId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    EInvoiceNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ViewUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    PdfUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    SignatureHash = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEInvoices_AppInvoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppConnectors_AppChargingStations_StationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAlerts_CreationTime",
                table: "AppAlerts",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppAlerts_Priority",
                table: "AppAlerts",
                column: "Priority");

            migrationBuilder.CreateIndex(
                name: "IX_AppAlerts_StationId",
                table: "AppAlerts",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppAlerts_Status",
                table: "AppAlerts",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AppAlerts_Type",
                table: "AppAlerts",
                column: "Type");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAppUsers_IdentityUserId",
                table: "AppAppUsers",
                column: "IdentityUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppAppUsers_IsActive",
                table: "AppAppUsers",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppChargingSessions_EndTime",
                table: "AppChargingSessions",
                column: "EndTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingSessions_OcppTransactionId",
                table: "AppChargingSessions",
                column: "OcppTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingSessions_StartTime",
                table: "AppChargingSessions",
                column: "StartTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingSessions_StationId",
                table: "AppChargingSessions",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingSessions_Status",
                table: "AppChargingSessions",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppChargingStations_IsEnabled",
                table: "AppChargingStations",
                column: "IsEnabled");

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingStations_StationCode",
                table: "AppChargingStations",
                column: "StationCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingStations_StationGroupId",
                table: "AppChargingStations",
                column: "StationGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_AppChargingStations_Status",
                table: "AppChargingStations",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AppConnectors_IsEnabled",
                table: "AppConnectors",
                column: "IsEnabled");

            migrationBuilder.CreateIndex(
                name: "IX_AppConnectors_StationId_ConnectorNumber",
                table: "AppConnectors",
                columns: new[] { "StationId", "ConnectorNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppConnectors_Status",
                table: "AppConnectors",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AppEInvoices_ExternalInvoiceId",
                table: "AppEInvoices",
                column: "ExternalInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEInvoices_InvoiceId",
                table: "AppEInvoices",
                column: "InvoiceId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppEInvoices_Status",
                table: "AppEInvoices",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AppFaults_DetectedAt",
                table: "AppFaults",
                column: "DetectedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AppFaults_Priority",
                table: "AppFaults",
                column: "Priority");

            migrationBuilder.CreateIndex(
                name: "IX_AppFaults_StationId",
                table: "AppFaults",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppFaults_Status",
                table: "AppFaults",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppInvoices_IssuedAt",
                table: "AppInvoices",
                column: "IssuedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AppInvoices_PaymentTransactionId",
                table: "AppInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMeterValues_Timestamp",
                table: "AppMeterValues",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentTransactions_GatewayTransactionId",
                table: "AppPaymentTransactions",
                column: "GatewayTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentTransactions_ReferenceCode",
                table: "AppPaymentTransactions",
                column: "ReferenceCode");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentTransactions_SessionId",
                table: "AppPaymentTransactions",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentTransactions_Status",
                table: "AppPaymentTransactions",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentTransactions_UserId",
                table: "AppPaymentTransactions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStationGroups_IsActive",
                table: "AppStationGroups",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppStationGroups_Name",
                table: "AppStationGroups",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AppStatusChangeLogs_StationId",
                table: "AppStatusChangeLogs",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStatusChangeLogs_Timestamp",
                table: "AppStatusChangeLogs",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_AppTariffPlans_EffectiveFrom",
                table: "AppTariffPlans",
                column: "EffectiveFrom");

            migrationBuilder.CreateIndex(
                name: "IX_AppTariffPlans_IsActive",
                table: "AppTariffPlans",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppTariffPlans_IsDefault",
                table: "AppTariffPlans",
                column: "IsDefault");

            migrationBuilder.CreateIndex(
                name: "IX_AppVehicles_IsActive",
                table: "AppVehicles",
                column: "IsActive");
