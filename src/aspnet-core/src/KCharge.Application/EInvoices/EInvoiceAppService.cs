...
[Authorize(KChargePermissions.EInvoices.Default)]
public class EInvoiceAppService : KChargeAppService, IEInvoiceAppService
{
    ...
    public async Task<EInvoiceDetailDto> GetAsync(Guid id)
    {
        ...
        if (invoice == null)
        {
            throw new BusinessException("KCharge:InvoiceNotFound");
        }
    ...
    [Authorize(KChargePermissions.EInvoices.Generate)]
    public async Task<EInvoiceResultDto> GenerateAsync(CreateEInvoiceDto input)
    {
        ...
        {
            throw new BusinessException("KCharge:EInvoiceAlreadyExists")
    ...
    [Authorize(KChargePermissions.EInvoices.Retry)]
    public async Task<EInvoiceResultDto> RetryAsync(Guid id)
    {
        ...
        {
            throw new BusinessException("KCharge:EInvoiceCannotRetry")
    ...
    [Authorize(KChargePermissions.EInvoices.Cancel)]
    public async Task CancelAsync(Guid id)
    {
        ...
        {
            throw new BusinessException("KCharge:EInvoiceAlreadyCancelled");
        }
