...
{
    [DbContext(typeof(KChargeDbContext))]
    partial class KChargeDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KCharge.Faults.Fault", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Notifications.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Payments.EInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Payments.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Payments.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Sessions.ChargingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Sessions.MeterValue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Stations.ChargingStation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Stations.Connector", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Stations.StationGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Stations.StatusChangeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Tariffs.TariffPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Vehicles.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KCharge.Payments.EInvoice", b =>
                {
                    b.HasOne("KCharge.Payments.Invoice", "Invoice")
                        .WithOne("EInvoice")
                        .HasForeignKey("KCharge.Payments.EInvoice", "InvoiceId")
            ...
            modelBuilder.Entity("KCharge.Payments.Invoice", b =>
                {
                    b.HasOne("KCharge.Payments.PaymentTransaction", "PaymentTransaction")
                        .WithOne("Invoice")
                        .HasForeignKey("KCharge.Payments.Invoice", "PaymentTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KCharge.Sessions.MeterValue", b =>
                {
                    b.HasOne("KCharge.Sessions.ChargingSession", null)
            ...
            modelBuilder.Entity("KCharge.Stations.ChargingStation", b =>
                {
                    b.HasOne("KCharge.Stations.StationGroup", null)
                        .WithMany("Stations")
            ...
            modelBuilder.Entity("KCharge.Stations.Connector", b =>
                {
                    b.HasOne("KCharge.Stations.ChargingStation", "Station")
                        .WithMany("Connectors")
