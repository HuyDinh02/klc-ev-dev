...
namespace KCharge.Controllers.Payments;

[ApiController]
[Route("api/v1/payments")]
public class PaymentController : KChargeController
{
...
public class PaymentMethodController : KChargeController
{
    private readonly IPaymentAppService _paymentAppService;
...
public class InvoiceController : KChargeController
{
    private readonly IPaymentAppService _paymentAppService;
